...
``` {r eval = FALSE}
m1 <- MBGC(modelName = "CC", y = c("y1","y2"), G = 2, gating = "C", data = gatingsim, maxit=5)
summary(m1)
m2 <- MBGC(modelName = "CC", y = c("y1","y2"), G = 3, gating = "C", data = gatingsim, maxit=5)
m3 <- MBGC(modelName = "CC", y = c("y1","y2"), G = 4, gating = "C", data = gatingsim, maxit=5)
m4 <- MBGC(modelName = "CC", y = c("y1","y2"), G = 5, gating = "C", data = gatingsim, maxit=5)
```
...
``` {r eval = FALSE}
m5 <- MBGC(modelName = "CC", y=c("y1","y2"), G = 2, gating = ~w1+w2+w3, data = gatingsim, maxit=5)
summary(m5)
