...
# expected.latent(c(2000,1000), alpha=c(20,40,50), beta=1)
# expected.latent(y=c(2,1), alpha=c(2,.6,1), beta=1)
# expected.latent(y=c(20,12), alpha=c(6,.9,1), beta=1)
# 
# expected.latent(y=c(62.16, 8090.79), alpha=c(137.6, 0.304, 13.34), beta=0.018)
