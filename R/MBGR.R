...
#' @param initialization Specifies initialization method for EM algorithm
...
MBGR <- function(modelName = c("VC","VI","VV","VE", "CV", "IV", "EV", "EC", "CE"),
  ...
  switch(modelName,
         ...
         CV = {
           ...
           res <- MBGR.CV(y=y,data=data,G=G,f4=f4,gating=gating,
                          maxit=maxit,tol=tol,
                          initialization=initialization,
                          verbose=verbose)
         },
         ...
         IV = {
           ...
           res <- MBGR.IV(y=y,data=data,G=G,f4=f4,gating=gating,
                          maxit=maxit,tol=tol,
                          initialization=initialization,
                          verbose=verbose)
         },
         ...
         CE = {
           ...
           res <- MBGR.CE(y=y,data=data,G=G,f4=f4,gating=gating,
                          maxit=maxit,tol=tol,
                          initialization=initialization,
                          verbose=verbose)
         },
